...
final class TimeUtil
{
    ...
    public static $NUMBER_OF_NANOSECONDS_IN_MICROSECOND = 1000;
    public static $NUMBER_OF_MICROSECONDS_IN_MILLISECOND = 1000;
    public static $NUMBER_OF_MILLISECONDS_IN_SECOND = 1000;
    public static $NUMBER_OF_MICROSECONDS_IN_SECOND
        = 1000 * 1000;
    public static $NUMBER_OF_SECONDS_IN_MINUTE = 60;
    public static $NUMBER_OF_MINUTES_IN_HOUR = 60;
    public static $NUMBER_OF_HOURS_IN_DAY = 24;
